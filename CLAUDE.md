...
This project is indexed by GitNexus as **CoXAgent** (6434 symbols, 16332 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
