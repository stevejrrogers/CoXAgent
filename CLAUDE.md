...
This project is indexed by GitNexus as **CoXAgent** (6458 symbols, 16416 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
