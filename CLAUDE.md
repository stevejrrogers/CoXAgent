...
This project is indexed by GitNexus as **CoXAgent** (7999 symbols, 20676 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
