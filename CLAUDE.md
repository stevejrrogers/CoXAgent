...
This project is indexed by GitNexus as **CoXAgent** (4532 symbols, 11763 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
