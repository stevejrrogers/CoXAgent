...
This project is indexed by GitNexus as **CoXAgent** (5322 symbols, 13396 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
