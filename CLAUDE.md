...
This project is indexed by GitNexus as **CoXAgent** (4146 symbols, 10602 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
