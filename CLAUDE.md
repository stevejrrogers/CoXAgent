...
This project is indexed by GitNexus as **CoXAgent** (4800 symbols, 12528 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
