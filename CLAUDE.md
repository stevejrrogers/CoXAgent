...
This project is indexed by GitNexus as **CoXAgent** (6442 symbols, 16363 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
