...
This project is indexed by GitNexus as **CoXAgent** (4862 symbols, 12700 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
