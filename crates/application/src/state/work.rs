...
pub struct Spend {
    ...
    /// are neither confined nor unconfined runs — they are an OS fault, and
    /// counting them as either hides it inside the agent's own failure rate.
    #[serde(default)]
    pub sandbox_refused_runs: u64,
