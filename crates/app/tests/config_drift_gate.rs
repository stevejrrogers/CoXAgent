...
//!
//
//   2. A #[serde(default)] pub coverage: CoverageConfig field on the existing top-level Config,
//      like every sibling section (step 2 of docs/CXA-B004-config-initializer.md). Its documented
//      defaults MUST be enabled=true/threshold=3 above all configured surfaces — produced by an
