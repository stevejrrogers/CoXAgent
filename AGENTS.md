...
This project is indexed by GitNexus as **CoXAgent** (4209 symbols, 10767 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
