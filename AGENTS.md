...
This project is indexed by GitNexus as **CoXAgent** (4161 symbols, 10630 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
