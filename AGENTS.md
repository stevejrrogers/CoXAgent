...
This project is indexed by GitNexus as **CoXAgent** (7279 symbols, 18733 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
