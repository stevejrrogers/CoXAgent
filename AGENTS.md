...
This project is indexed by GitNexus as **CoXAgent** (9086 symbols, 22745 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
