...
This project is indexed by GitNexus as **CoXAgent** (8033 symbols, 20783 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
