...
This project is indexed by GitNexus as **CoXAgent** (4221 symbols, 10800 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
