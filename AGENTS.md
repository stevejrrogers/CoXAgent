...
This project is indexed by GitNexus as **CoXAgent** (6453 symbols, 16405 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
