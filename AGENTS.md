...
This project is indexed by GitNexus as **CoXAgent** (6455 symbols, 16411 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
