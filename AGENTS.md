...
This project is indexed by GitNexus as **CoXAgent** (5206 symbols, 13210 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
